...
pub use module::*;
pub use traits::SwapTokenInterface;
...
pub mod module {
	...
	impl<T: Config> Pallet<T> {
		...
		pub fn list_provisioning(
			...
			ensure_root(origin)?; // T::ListingOrigin::ensure_origin(origin)?;
...
impl<T: Config> SwapTokenInterface<T::AccountId, Balance, CurrencyId> for Pallet<T> {
